...
# CONNECTION_STRING = "postgresql://postgres:123456@localhost:5433/wateraid" 
    ...
    # this version is only to display the deployed app and thus uses the hosted database connection string
    # instruction for deploying database on Neon is still provided in the system manual
